...
//     const svg = new SVG();
//     const expected = `<svg version=\"1.1\" width=\"300\" height=\"200\" xmlns=\"http://www.w3.org/2000/svg\"><polygon points="150, 18 244, 182 56, 182" fill="blue" /></svg>` 
//     expect(svg.render()).toEqual(expected)
// })
...
//     const svg = new SVG();
//     const expected = `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">< text x = "150" y = "125" font-size="60" text - anchor="middle">AMD</text ></svg>`
//     expect(svg.render()).toEqual(expected)
// })
test('should render an svg file with a triangle shape', () => {
    const svg = new SVG();
